            ...
            <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-slate-500 mt-1 ml-14">View all trip records with timestamps and status</p>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        <motion.button
                            ...
                            className="flex items-center gap-2 px-6 py-2.5 bg-slate-800 hover:bg-slate-900 text-white rounded-xl transition-all font-bold text-sm shadow-md"
                        >
                            <Download size={16} />
                        ...
                        <motion.button
                            ...
                            onClick={fetchTrips}
                            disabled={loading}
                            className="p-2.5 bg-white border border-slate-200 hover:bg-slate-50 text-slate-600 rounded-xl transition-all disabled:opacity-50 shadow-sm"
                            title="Refresh"
                        >
                ...
                {selectedTripIds.length > 0 && (
                    <div className="bg-emerald-600 px-6 py-3 rounded-xl shadow-lg flex items-center justify-between mb-6 animate-in slide-in-from-top duration-300">
                        ...
                        <div className="flex items-center gap-3">
                            {selectedTripIds.length === 1 && (
                                <button
                                    ...
                                    className="px-4 py-2 bg-white text-emerald-600 rounded-lg text-sm font-bold shadow-sm hover:bg-slate-50 transition-all flex items-center gap-2"
                                >
                                    <Map size={16} />
                                    Preview Details
                                </button>
                ...
                {trips.length > 0 && (
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
                            ...
                            <div>
                                <p className="text-[10px] text-slate-400 uppercase font-black tracking-widest mb-0.5">Total Trips</p>
                                <p className="text-2xl font-black text-slate-900 tracking-tight">{filteredTrips.length}</p>
                            </div>
                        </div>
                        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
                            <div className="w-12 h-12 rounded-xl bg-green-50 text-green-600 flex items-center justify-center border border-green-100/50 shadow-sm">
                                <Bus size={22} />
                            </div>
                            <div>
                                <p className="text-[10px] text-slate-400 uppercase font-black tracking-widest mb-0.5">Active</p>
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
                            ...
                            <div>
                                <p className="text-[10px] text-slate-400 uppercase font-black tracking-widest mb-0.5">Completed</p>
                                <p className="text-2xl font-black text-slate-900 tracking-tight">
                            ...
                            <table className="w-full">
                                ...
                                <tbody className="divide-y divide-slate-100">
                                    {paginatedTrips.map((trip) => (
                                        <tr key={trip._id} className={`hover:bg-slate-50 transition-colors ${selectedTripIds.includes(trip._id) ? 'bg-emerald-50/50' : ''}`}>
                        ...
                        <div className="px-6 py-4 bg-slate-50 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
                            <div className="flex items-center gap-3">
                                ...
                                <select
                                    ...
                                    className="bg-white border border-slate-200 text-sm rounded-lg px-2 py-1 focus:ring-2 focus:ring-emerald-500 outline-none"
                                >
